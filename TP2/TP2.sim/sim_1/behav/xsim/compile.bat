...
REM
REM Generated by Vivado on Wed Oct 29 05:21:57 -0300 2025
...
echo "xvlog --incr --relax -prj tb_uart_top_vlog.prj"
call xvlog  --incr --relax -prj tb_uart_top_vlog.prj -log xvlog.log
